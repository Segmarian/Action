...
from character.forms import CharacterSkillFormset, CharacterSchtickFormset, CharacterFlawFormset, \
    ...
    CharacterDetailForm, CharacterAttributeForm
...
class CharacterSkillView (UpdateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if self.form_valid(attribute_formset, skill_formset, proficiency_formsets, schtick_formset, flaw_formset):
            return self.form_valid(attribute_formset,
                                   skill_formset,
                                   proficiency_formsets,
                                   schtick_formset,
                                   flaw_formset)
        else:
            return self.form_invalid(attribute_formset,
                                     skill_formset,
                                     proficiency_formsets,
                                     schtick_formset,
                                     flaw_formset)
    ...
    def form_valid(self, attribute_formset, skill_formset, proficiency_formsets, schtick_formset, flaw_formset):
    ...
    def form_invalid(self, attribute_formset, skill_formset, proficiency_formsets, schtick_formset, flaw_formset):
